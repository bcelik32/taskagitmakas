...
namespace taskagitmakas
{
    public partial class Form3 : Form
    {
        ...
        private async void button1_Click(object sender, EventArgs e)
        {
            ...
            FirebaseResponse getResponse = await client.GetAsync("birinci");
            ...
            FirebaseResponse updateResponse = await client.UpdateAsync("birinci", newData);
        ...
        private async void button10_Click(object sender, EventArgs e)
        {
            ...
            FirebaseResponse getResponseBirinci = await client.GetAsync("birinci");
            Data currentDataBirinci = getResponseBirinci.ResultAs<Data>();

            // "ikinci" kümesinden mevcut veriyi çek
            FirebaseResponse getResponseIkinci = await client.GetAsync("ikinci");
            ...
            FirebaseResponse updateResponseBirinci = await client.UpdateAsync("birinci", newDataBirinci);
            ...
            FirebaseResponse updateResponseIkinci = await client.UpdateAsync("ikinci", newDataIkinci);
